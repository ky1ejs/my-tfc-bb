...
enum MyTfcBb_V1_GetDeliveriesFilterType: SwiftProtobuf.Enum {
...
extension MyTfcBb_V1_GetDeliveriesFilterType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [MyTfcBb_V1_GetDeliveriesFilterType] = [
    .uncollected,
    .active,
    .collected,
    .search,
...
enum MyTfcBb_V1_PushPlatform: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unspecified // = 0
  case ios // = 1
  case android // = 2
...
extension MyTfcBb_V1_PushPlatform: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [MyTfcBb_V1_PushPlatform] = [
    .unspecified,
    .ios,
    .android,
    .web,
...
enum MyTfcBb_V1_TokenEnv: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unspecified // = 0
  case production // = 1
  case staging // = 2
...
extension MyTfcBb_V1_TokenEnv: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [MyTfcBb_V1_TokenEnv] = [
    .unspecified,
    .production,
    .staging,
  ]
...
struct MyTfcBb_V1_LogInRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct MyTfcBb_V1_LogInResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct MyTfcBb_V1_GetDeliveriesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var filter: MyTfcBb_V1_GetDeliveriesFilterType = .uncollected
...
struct MyTfcBb_V1_GetDeliveriesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var deliveries: [MyTfcBb_V1_Delivery] = []
...
struct MyTfcBb_V1_UpdatePushTokenRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var platform: MyTfcBb_V1_PushPlatform = .unspecified

  var env: MyTfcBb_V1_TokenEnv = .unspecified
...
extension MyTfcBb_V1_GetDeliveriesFilterType: @unchecked Sendable {}
extension MyTfcBb_V1_PushPlatform: @unchecked Sendable {}
extension MyTfcBb_V1_TokenEnv: @unchecked Sendable {}
extension MyTfcBb_V1_Delivery: @unchecked Sendable {}
extension MyTfcBb_V1_LogInRequest: @unchecked Sendable {}
extension MyTfcBb_V1_LogInResponse: @unchecked Sendable {}
extension MyTfcBb_V1_GetDeliveriesRequest: @unchecked Sendable {}
extension MyTfcBb_V1_GetDeliveriesResponse: @unchecked Sendable {}
extension MyTfcBb_V1_UpdatePushTokenRequest: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "my_tfc_bb.v1"

extension MyTfcBb_V1_GetDeliveriesFilterType: SwiftProtobuf._ProtoNameProviding {
...
extension MyTfcBb_V1_PushPlatform: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension MyTfcBb_V1_TokenEnv: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "TOKEN_ENV_UNSPECIFIED"),
    1: .same(proto: "PRODUCTION"),
    2: .same(proto: "STAGING"),
  ]
}

extension MyTfcBb_V1_Delivery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_Delivery, rhs: MyTfcBb_V1_Delivery) -> Bool {
...
extension MyTfcBb_V1_LogInRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_LogInRequest, rhs: MyTfcBb_V1_LogInRequest) -> Bool {
...
extension MyTfcBb_V1_LogInResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_LogInResponse, rhs: MyTfcBb_V1_LogInResponse) -> Bool {
    if lhs.deviceID != rhs.deviceID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension MyTfcBb_V1_GetDeliveriesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_GetDeliveriesRequest, rhs: MyTfcBb_V1_GetDeliveriesRequest) -> Bool {
...
extension MyTfcBb_V1_GetDeliveriesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_GetDeliveriesResponse, rhs: MyTfcBb_V1_GetDeliveriesResponse) -> Bool {
...
extension MyTfcBb_V1_UpdatePushTokenRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: MyTfcBb_V1_UpdatePushTokenRequest, rhs: MyTfcBb_V1_UpdatePushTokenRequest) -> Bool {
