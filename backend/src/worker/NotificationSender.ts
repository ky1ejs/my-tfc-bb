...
export async function pushToUsersDevices(user: User, title: string, body: string) {
...
export async function pushToDevice(token: PushToken, title: string, message: string): Promise<void> {
  console.log(message);
